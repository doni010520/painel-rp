...
export default async function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  let role: import("@/lib/access").Role | null = null;
  ...
  if (hasEnv) {
    ...
    role = (session.profile?.role as import("@/lib/access").Role) ?? null;
  }
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        <Topbar userName={userName} orgName={orgName} email={email} userId={userId} role={role} />
        {!hasEnv && (
